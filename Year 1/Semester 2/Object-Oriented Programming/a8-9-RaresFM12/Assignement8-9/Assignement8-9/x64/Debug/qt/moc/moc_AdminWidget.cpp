...
template <> constexpr inline auto AdminWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11AdminWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'FilteredTable'
        QtMocHelpers::SlotData<void(std::vector<Event>)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'DeleteEvent'
...
void AdminWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->populateTable(); break;
        case 2: _t->FilteredTable((*reinterpret_cast< std::add_pointer_t<std::vector<Event>>>(_a[1]))); break;
        case 3: _t->DeleteEvent(); break;
        case 4: _t->UpdateEvent(); break;
        case 5: _t->FilterEventByPeople(); break;
        default: ;
        }
    }
}
